...
def main():
    ...
    print(f"Updated Savings Account Balance: ${updated_savings_balance: .2f}, Interest Earned: ${savings_interest_earned: .2f}")
    ...
    # Create CD Account and calculate interest
    ...
    print(f"Updated CD Account Balance: ${updated_cd_balance : .2f}, Interest Earned: ${cd_interest_earned: .2f}:")
